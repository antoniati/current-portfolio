...
export const Footer = (props: Props) => {
      return (
            <footer className='w-full mt-[40px]'>
                  <Divider />
                  <div>
                        <Grid numItems={2} numItemsSm={3} className='w-full py-[40px] px-4 md:px-[100px] gap-[40px]'>
                              <div>
                  ...
                  <Divider />
                  <Flex className="px-[40px] sm:text-start text-center flex-col sm:flex-row gap-[20px] py-[40px]">
