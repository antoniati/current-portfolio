...
import { Button, Callout, Card, Divider, Flex, Grid, TextInput, Title } from "@tremor/react"
...
import { BounceLoading } from "../loadings/BounceLoading";
...
export const UserEditForm = ({ userId }: { userId: string }) => {
      ...
      return (
            <div className="main-container">
                  <Card className="w-full" style={{ paddingTop: "140px" }}>
